 ...
 * @property-read \Domain\Office\VisitingCareForPwsdSpecifiedOfficeAddition $specifiedOfficeAddition 特定事業所加算
 ...
 */
final class VisitingCareForPwsdCalcSpec extends Entity
{
    use Versionable;
