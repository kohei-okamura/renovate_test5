 ...
 * @property-read string $problem 解決すべき課題
 * @property-read \Domain\Project\Objective $longTermObjective 長期目標
 * @property-read \Domain\Project\Objective $shortTermObjective 短期目標
 * @property-read \Domain\Project\LtcsProjectProgram[] $programs 週間サービス計画
 ...
 */
final class LtcsProject extends Entity
{
    use Versionable;
    ...
    protected function jsonables(): array
    {
        return [
            ...
            'problem' => true,
            'longTermObjective' => true,
            'shortTermObjective' => true,
            'programs' => true,
            'isEnabled' => true,
            'version' => true,
            'createdAt' => true,
