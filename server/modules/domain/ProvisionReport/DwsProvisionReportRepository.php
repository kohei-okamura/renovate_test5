...
/**
 * DwsProvisionReport Repository Interface.
 */
interface DwsProvisionReportRepository extends Repository
{
    /**
     * {@inheritdoc}
     *
     ...
     * {@inheritdoc}
     *
     * @param \Domain\ProvisionReport\DwsProvisionReport $entity
