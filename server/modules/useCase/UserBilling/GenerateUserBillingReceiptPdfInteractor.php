...
/**
 * 利用者請求：領収書 PDF 生成ユースケース実装.
 */
final class GenerateUserBillingReceiptPdfInteractor implements GenerateUserBillingReceiptPdfUseCase
{
    private const STORE_TO = 'exported';
    private const TEMPLATE = 'pdfs.user-billings.receipt';

    private BuildUserBillingReceiptPdfParamUseCase $buildPdfUseCase;
    private LookupUserBillingUseCase $lookupUserBillingUseCase;
    private StorePdfUseCase $storePdfUseCase;

    /**
     * {@link \UseCase\UserBilling\GenerateUserBillingReceiptPdfInteractor} constructor.
     *
     * @param \UseCase\UserBilling\BuildUserBillingReceiptPdfParamUseCase $buildPdfUseCase
    ...
    public function __construct(
        BuildUserBillingReceiptPdfParamUseCase $buildPdfUseCase,
