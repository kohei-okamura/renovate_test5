...
/**
 * 利用者請求：請求書 PDF 生成ユースケース実装.
 */
final class GenerateUserBillingInvoicePdfInteractor implements GenerateUserBillingInvoicePdfUseCase
{
    private const STORE_TO = 'exported';
    private const TEMPLATE = 'pdfs.user-billings.invoice';

    private BuildUserBillingInvoicePdfParamUseCase $buildPdfUseCase;
    private LookupUserBillingUseCase $lookupUserBillingUseCase;
    private StorePdfUseCase $storePdfUseCase;

    /**
     * {@link \UseCase\UserBilling\GenerateUserBillingInvoicePdfInteractor} constructor.
     *
     * @param \UseCase\UserBilling\BuildUserBillingInvoicePdfParamUseCase $buildPdfUseCase
    ...
    public function __construct(
        BuildUserBillingInvoicePdfParamUseCase $buildPdfUseCase,
