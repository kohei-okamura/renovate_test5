...
/**
 * 障害福祉サービス：利用者別算定情報編集実装.
 */
class EditUserDwsCalcSpecInteractor implements EditUserDwsCalcSpecUseCase
{
    use Logging;
     ...
     * Constructor.
     *
     * @param \UseCase\User\LookupUserDwsCalcSpecUseCase $lookupUseCase
     * @param \Domain\User\UserDwsCalcSpecRepository $repository
     * @param \Domain\TransactionManagerFactory $transactionManagerFactory
     */
    public function __construct(
        private LookupUserDwsCalcSpecUseCase $lookupUseCase,
    ...
    {
        $x = $this->transaction->run(function () use ($context, $userId, $id, $values): UserDwsCalcSpec {
            $entity = $this->lookupUseCase->handle($context, Permission::updateUserDwsCalcSpecs(), $userId, $id)
                ->headOption()
