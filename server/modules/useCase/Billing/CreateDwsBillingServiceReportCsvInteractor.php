...
/**
 * 障害福祉サービス：サービス提供実績記録票 CSV 生成ユースケース実装.
 */
final class CreateDwsBillingServiceReportCsvInteractor implements CreateDwsBillingServiceReportCsvUseCase
{
    ...
    /**
     * {@link \UseCase\Billing\CreateDwsBillingServiceReportCsvInteractor} constructor.
     *
     * @param \Domain\Config\Config $config
     * @param \UseCase\Contracts\TokenMaker $tokenMaker
     * @param \UseCase\Billing\BuildDwsBillingServiceReportRecordListUseCase $buildRecordListUseCase
    ...
    public function __construct(
        ...
        private BuildDwsBillingServiceReportRecordListUseCase $buildRecordListUseCase,
    ...
    private function createName(DwsBilling $billing, Carbon $providedIn): string
    {
        ...
        return $this->generateFileNameUseCase->handle('dws_service_report_csv', $placeholders);
    }
}
