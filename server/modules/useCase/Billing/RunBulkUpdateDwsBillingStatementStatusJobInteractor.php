...
/**
 * 障害福祉サービス：明細書状態一括更新ジョブ実行ユースケース実装.
 */
final class RunBulkUpdateDwsBillingStatementStatusJobInteractor implements RunBulkUpdateDwsBillingStatementStatusJobUseCase
{
    private RunJobUseCase $runJobUseCase;
    private BulkUpdateDwsBillingStatementStatusUseCase $useCase;
     ...
     * @param \UseCase\Billing\BulkUpdateDwsBillingStatementStatusUseCase $useCase
     * @param ConfirmDwsBillingStatusUseCase $confirmBillingStatusUseCase
     * @param LookupDwsBillingUseCase $lookupDwsBillingUseCase
     */
    public function __construct(
        RunJobUseCase $runJobUseCase,
        BulkUpdateDwsBillingStatementStatusUseCase $useCase,
