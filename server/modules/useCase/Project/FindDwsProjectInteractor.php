...
/**
 * 障害福祉サービス計画検索ユースケース実装.
 */
final class FindDwsProjectInteractor implements FindDwsProjectUseCase
{
     ...
     * Constructor.
     *
     * @param \Domain\Project\DwsProjectFinder $finder
     */
    public function __construct(DwsProjectFinder $finder)
    {
        $this->finder = $finder;
    }
