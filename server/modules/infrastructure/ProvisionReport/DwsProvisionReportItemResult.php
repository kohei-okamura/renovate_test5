...
/**
 * 障害福祉サービス：予実：要素：実績 Eloquent モデル.
 *
 * @property int $id 障害福祉サービス：予実：要素：実績ID
 ...
 */
final class DwsProvisionReportItemResult extends Model implements Domainable
{
    use ScheduleHolder;
     ...
     * テーブル名.
     */
    public const TABLE = 'dws_provision_report_item_result';
    ...
    /**
     * HasMany: {@link \Infrastructure\ProvisionReport\DwsProvisionReportItemResultServiceOption}.
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function options(): HasMany
    {
        return $this->hasMany(DwsProvisionReportItemResultServiceOption::class);
    }
     ...
     * @param int $reportId
     * @param int $sortOrder
     * @return \Infrastructure\ProvisionReport\DwsProvisionReportItemResult
     */
    ...
    protected function getOptionsAttribute(): array
    {
        return $this->mapRelation(
            'options',
            fn (DwsProvisionReportItemResultServiceOption $option): ServiceOption => ServiceOption::from(
