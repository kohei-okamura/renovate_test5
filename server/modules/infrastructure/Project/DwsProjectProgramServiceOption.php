 ...
 *
 * @property int $dws_project_program_id 障害福祉サービス：計画：週間サービス計画ID
 */
final class DwsProjectProgramServiceOption extends Model implements ServiceOptionProvider
{
     ...
     * テーブル名.
     */
    public const TABLE = 'dws_project_program_service_option';
