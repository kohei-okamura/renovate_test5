...
use Domain\Office\OfficeLtcsCareManagementService as DomainOfficeLtcsCareManagementService;
use Infrastructure\Domainable;
use Infrastructure\Model;

/**
 * 事業所：介護保険サービス：居宅介護支援 Eloquent モデル.
 *
 * @property int $id 事業所：介護保険サービス：居宅介護支援ID
 ...
 * @mixin \Eloquent
 */
final class OfficeLtcsCareManagementService extends Model implements Domainable
{
    /**
     * テーブル名.
     */
    public const TABLE = 'office_ltcs_care_management_service';
     ...
     *
     * @param \Domain\Office\OfficeLtcsCareManagementService $domain
     * @return \Infrastructure\Office\OfficeLtcsCareManagementService
     */
    public static function fromDomain(DomainOfficeLtcsCareManagementService $domain): self
    {
    ...
    /** {@inheritdoc} */
    public function toDomain(): DomainOfficeLtcsCareManagementService
    {
        $attrs = $this->toDomainAttributes(self::DOMAIN_ATTRIBUTES);
        return DomainOfficeLtcsCareManagementService::create($attrs);
    }
}
