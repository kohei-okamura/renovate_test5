...
/**
 * {@link \Domain\Office\HomeHelpServiceCalcSpecFinder} Eloquent 実装.
 */
final class HomeHelpServiceCalcSpecFinderEloquentImpl extends EloquentFinder implements HomeHelpServiceCalcSpecFinder
{
    ...
    {
        return ['home_help_service_calc_spec.*'];
    }

    /** {@inheritdoc} */
    protected function getQueryBuilder(): Builder
    {
        return HomeHelpServiceCalcSpec::query()
            ->join(
                'home_help_service_calc_spec_to_attr',
                'home_help_service_calc_spec.id',
                '=',
                'home_help_service_calc_spec_to_attr.home_help_service_calc_spec_id'
            )
            ->join(
                'home_help_service_calc_spec_attr',
                'home_help_service_calc_spec_to_attr.home_help_service_calc_spec_attr_id',
                '=',
                'home_help_service_calc_spec_attr.id'
            );
    }
    ...
    {
        return HomeHelpServiceCalcSpec::TABLE;
    }
