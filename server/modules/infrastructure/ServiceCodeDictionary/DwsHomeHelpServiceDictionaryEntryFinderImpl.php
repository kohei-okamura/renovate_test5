...
/**
 * {@link \Domain\ServiceCodeDictionary\DwsHomeHelpServiceDictionaryEntryFinder} 実装.
 */
final class DwsHomeHelpServiceDictionaryEntryFinderImpl implements DwsHomeHelpServiceDictionaryEntryFinder
{
    ...
    public function find(array $filterParams, array $paginationParams): FinderResult
    {
        ...
        $entries = Seq::fromArray($array)->map(fn (array $x): DomainEntry => DomainEntry::create([
            ...
            'buildingType' => DwsHomeHelpServiceBuildingType::from($x['buildingType']),
            'daytimeDuration' => IntRange::create($x['daytimeDuration']),
            'morningDuration' => IntRange::create($x['morningDuration']),
            'nightDuration' => IntRange::create($x['nightDuration']),
            'midnightDuration1' => IntRange::create($x['midnightDuration1']),
            'midnightDuration2' => IntRange::create($x['midnightDuration2']),
            'createdAt' => null,
            'updatedAt' => null,
        ] + $x));
    ...
    {
        throw new LogicException('Do not call DwsHomeHelpServiceDictionaryEntryFinder::cursor()');
    }
