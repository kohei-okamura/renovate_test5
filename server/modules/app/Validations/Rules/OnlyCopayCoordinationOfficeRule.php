...
/**
 * 入力値の「利用者負担上限額管理結果票：明細」の他社のサービス提供がない場合に上限管理事業所について上限管理事業所のみであることを検証する.
 *
 * @mixin \App\Validations\CustomValidator
 */
trait OnlyCopayCoordinationOfficeRule
{
    /**
     * 検証処理.
     *
     ...
     */
    protected function validateOnlyCopayCoordinationOffice(string $attribute, $value, array $parameters): bool
    {
        ...
        return $items->size() === 1 && $dwsBilling->office->officeId === $headItem['officeId'];
    }
}
