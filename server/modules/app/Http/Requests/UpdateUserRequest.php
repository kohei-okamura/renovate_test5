 ...
 * @property-read \Domain\Common\Carbon $birthday
 ...
 */
class UpdateUserRequest extends StaffRequest implements ValidatesWhenResolved
{
    use FormRequest;
    ...
    protected function rules(array $input): array
    {
        ...
        return [
            ...
            'isEnabled' => ['required', 'boolean_ext', 'user_status_can_update_to_false:id'],
        ];
    }
