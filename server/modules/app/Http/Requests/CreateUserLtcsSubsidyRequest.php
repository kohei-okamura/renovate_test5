 ...
 */
class CreateUserLtcsSubsidyRequest extends StaffRequest implements ValidatesWhenResolved
{
    use FormRequest;
     ...
     */
    public function payload(): UserLtcsSubsidy
    {
        $values = [
        ...
        return UserLtcsSubsidy::create($values);
    }
