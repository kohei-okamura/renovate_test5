 ...
 */
class CreateVisitingCareForPwsdCalcSpecRequest extends StaffRequest implements ValidatesWhenResolved
{
    use FormRequest;

    /**
     * 事業所算定情報（障害・重度訪問介護）を生成する.
     *
     * @return \Domain\Office\VisitingCareForPwsdCalcSpec
     */
    public function payload(): VisitingCareForPwsdCalcSpec
    {
        $values = [
            ...
            'specifiedOfficeAddition' => VisitingCareForPwsdSpecifiedOfficeAddition::from($this->specifiedOfficeAddition),
        ...
        return VisitingCareForPwsdCalcSpec::create($values);
    }
    ...
    protected function rules(array $input): array
    {
        return [
            ...
            'specifiedOfficeAddition' => ['required', 'visiting_care_for_pwsd_specified_office_addition'],
