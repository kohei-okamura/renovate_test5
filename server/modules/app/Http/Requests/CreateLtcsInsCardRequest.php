 ...
 */
class CreateLtcsInsCardRequest extends StaffRequest implements ValidatesWhenResolved
{
    use FormRequest;
     ...
     */
    public function payload(): LtcsInsCard
    {
        $values = [
        ...
        return LtcsInsCard::create($values + ['maxBenefitQuotas' => $maxBenefitQuotas->toArray()]);
    }
    ...
    protected function rules(array $input): array
    {
        return [
            ...
            'effectivatedOn' => ['required', 'date', 'no_ltcs_ins_card_three_more_than_valid:' . Permission::createLtcsInsCards()],
