 ...
 * @property-read string $bankBranchName
 ...
 */
class UpdateUserBankAccountRequest extends StaffRequest implements ValidatesWhenResolved
{
    use FormRequest;
    ...
    protected function rules(array $input): array
    {
        return [
            ...
            'bankAccountNumber' => ['required', 'bank_account_number_digits:bankCode'],
