 ...
 */
class CreateDwsProjectRequest extends StaffRequest implements ValidatesWhenResolved
{
    use FormRequest;
     ...
     */
    public function payload(): DwsProject
    {
    ...
    {
        return [
            'officeId' => ['required', 'office_exists:' . Permission::createDwsProjects()],
            'staffId' => ['required', 'staff_exists:' . Permission::createDwsProjects()],
            ...
            'programs.*.ownExpenseProgramId' => [
                'nullable',
                'own_expense_program_exists:' . Permission::createDwsProjects(),
                'own_expense_program_belongs_to_office:officeId,' . Permission::createDwsProjects(),
            ],
