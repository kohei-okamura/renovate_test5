 ...
 */
class CreateLtcsProjectRequest extends StaffRequest implements ValidatesWhenResolved
{
    use FormRequest;
     ...
     */
    public function payload(): LtcsProject
    {
    ...
    {
        return [
            'officeId' => ['required', 'office_exists:' . Permission::createLtcsProjects()],
            'staffId' => ['required', 'staff_exists:' . Permission::createLtcsProjects()],
            ...
            'programs.*.ownExpenseProgramId' => [
                'nullable',
                'own_expense_program_exists:' . Permission::createLtcsProjects(),
                'own_expense_program_belongs_to_office:officeId,' . Permission::createLtcsProjects(),
            ],
