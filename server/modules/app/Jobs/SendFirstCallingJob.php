...
/**
 * SendFirstCalling Job.
 */
class SendFirstCallingJob extends Job
{
     ...
     * 出勤確認第一呼び出しを行う.
     *
     * @param \UseCase\Calling\SendFirstCallingUseCase $useCase
     */
    public function handle(SendFirstCallingUseCase $useCase): void
    {
