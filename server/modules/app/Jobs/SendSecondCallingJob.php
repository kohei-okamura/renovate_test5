...
/**
 * SendSecondCalling Job.
 */
final class SendSecondCallingJob extends Job
{
     ...
     * 出勤確認第二呼び出しを行う.
     *
     * @param \UseCase\Calling\SendSecondCallingUseCase $useCase
     */
    public function handle(SendSecondCallingUseCase $useCase): void
    {
