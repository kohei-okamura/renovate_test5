...
/**
 * {@link \Domain\DwsAreaGrade\DwsAreaGradeFee} のテスト.
 */
final class DwsAreaGradeFeeTest extends Test
{
    use CarbonMixin;
    ...
    protected DwsAreaGradeFee $domain;
    ...
    public static function _setUpSuite(): void
    {
        self::beforeEachSpec(function (self $self): void {
            ...
            $self->domain = DwsAreaGradeFee::create($self->values);
        });
    }
