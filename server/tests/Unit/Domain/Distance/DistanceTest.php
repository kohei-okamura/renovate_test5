...
namespace Tests\Unit\Domain\Distance;
...
/**
 * {@link \Domain\Common\Distance} Test.
 */
class DistanceTest extends Test
{
    ...
    {
        static::beforeEachSpec(function (DistanceTest $self): void {
            $self->values = [
                'distance' => 0.0,
                'destination' => Office::create(),
            ];
            $self->domain = Distance::create($self->values);
        });
    }
