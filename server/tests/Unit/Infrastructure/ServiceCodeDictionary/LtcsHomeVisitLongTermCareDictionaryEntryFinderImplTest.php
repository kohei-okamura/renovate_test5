...
/**
 * {@link \Infrastructure\ServiceCodeDictionary\LtcsHomeVisitLongTermCareDictionaryEntryFinderImpl} のテスト.
 */
final class LtcsHomeVisitLongTermCareDictionaryEntryFinderImplTest extends Test
{
    use ConfigMixin;
    ...
    private LtcsHomeVisitLongTermCareDictionaryEntryFinderImpl $finder;
    ...
    public static function _setUpSuite(): void
    {
        ...
        self::beforeEachSpec(function (self $self): void {
            $self->finder = app(LtcsHomeVisitLongTermCareDictionaryEntryFinderImpl::class);
        });
    }
        ...
        $this->should('call api', function () {
            $actual = $this->finder->find(
                [
                    ...
                    'q' => ServiceCode::fromString('118300')->toString(),
                ],
                ['all' => true]
            );
