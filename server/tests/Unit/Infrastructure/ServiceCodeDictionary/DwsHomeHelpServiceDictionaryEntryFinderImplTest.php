...
/**
 * {@link \Infrastructure\ServiceCodeDictionary\DwsHomeHelpServiceDictionaryEntryFinderImpl} のテスト.
 */
final class DwsHomeHelpServiceDictionaryEntryFinderImplTest extends Test
{
    use ConfigMixin;
    ...
    private DwsHomeHelpServiceDictionaryEntryFinderImpl $finder;
    ...
    public static function _setUpSuite(): void
    {
        ...
        self::beforeEachSpec(function (self $self): void {
            $self->finder = app(DwsHomeHelpServiceDictionaryEntryFinderImpl::class);
        });
    }
