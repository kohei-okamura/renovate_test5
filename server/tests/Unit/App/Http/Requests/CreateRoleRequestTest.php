...
/**
 * CreateRoleRequest のテスト.
 */
class CreateRoleRequestTest extends Test
{
    use CarbonMixin;
    use ConfigMixin;
    ...
    protected CreateRoleRequest $request;
     ...
     */
    private function expectedPayload(array $input): Role
    {
        return Role::create([
            'name' => $input['name'],
