...
/**
 * UpdateHomeHelpServiceCalcSpecRequest のテスト
 */
class UpdateHomeHelpServiceCalcSpecRequestTest extends Test
{
    use CarbonMixin;
    use ConfigMixin;
    ...
    protected UpdateHomeHelpServiceCalcSpecRequest $request;
    ...
    {
        static::beforeEachSpec(function (UpdateHomeHelpServiceCalcSpecRequestTest $self): void {
            $self->homeHelpServiceCalcSpec = $self->examples->homeHelpServiceCalcSpecs[0];

            $self->request = new UpdateHomeHelpServiceCalcSpecRequest();
    ...
    {
        $this->should('payload return HomeHelpServiceCalcSpecs', function (): void {
    ...
    {
        $homeHelpServiceCalcSpecs = $this->homeHelpServiceCalcSpec;
        return [
            'period' => [
                'start' => $homeHelpServiceCalcSpecs->period->start->format('Y-m-d'),
                'end' => $homeHelpServiceCalcSpecs->period->end->format('Y-m-d'),
            ],
            'specifiedOfficeAddition' => $homeHelpServiceCalcSpecs->specifiedOfficeAddition->value(),
            'treatmentImprovementAddition' => $homeHelpServiceCalcSpecs->treatmentImprovementAddition->value(),
            'specifiedTreatmentImprovementAddition' => $homeHelpServiceCalcSpecs->specifiedTreatmentImprovementAddition->value(),
            'baseIncreaseSupportAddition' => $homeHelpServiceCalcSpecs->baseIncreaseSupportAddition->value(),
        ];
    }
