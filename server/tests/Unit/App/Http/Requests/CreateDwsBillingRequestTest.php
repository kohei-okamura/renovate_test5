...
/**
 * {@link \App\Http\Requests\CreateDwsBillingRequest} のテスト.
 */
final class CreateDwsBillingRequestTest extends Test
{
    use ConfigMixin;
    ...
    private CreateDwsBillingRequest $request;
    ...
    public static function _setUpSuite(): void
    {
        self::beforeEachSpec(function (self $self): void {
            $self->request = new CreateDwsBillingRequest();
            ...
            $self->dwsProvisionReportFinder
                ->allows('find')
                ->andReturn(FinderResult::from(Seq::fromArray($self->examples->dwsProvisionReports), Pagination::create()))
                ->byDefault();
        });
    }
