...
/**
 * UpdateLtcsInsCardRequest のテスト
 */
class UpdateLtcsInsCardRequestTest extends Test
{
    use ConfigMixin;
    ...
    protected UpdateLtcsInsCardRequest $request;
    ...
    {
        static::beforeEachSpec(function (UpdateLtcsInsCardRequestTest $self): void {
            $self->request = new UpdateLtcsInsCardRequest();
    ...
    public function describe_payload(): void
    {
        $this->should('payload return array for update', function (): void {
            ...
            $expected = $this->expectedPayload($this->defaultInput());
            unset($expected['id'], $expected['userId']);
        ...
        $this->should(
            ...
            function ($key): void {
                ...
                $expected = $this->expectedPayload($forgetInput);
                unset($expected['id'], $expected['userId']);
                $this->assertEquals(
                    $expected,
    ...
    public function describe_validation(): void
    {
        ...
        $examples = [
            'when status is empty' => [
                ['status' => ['入力してください。']],
                ['status' => ''],
                ['status' => $this->examples->ltcsInsCards[0]->status->value()],
            ],
            ...
            'when insNumber is empty' => [
                ['insNumber' => ['入力してください。']],
                ['insNumber' => ''],
                ['insNumber' => $this->examples->ltcsInsCards[0]->insNumber],
            ],
            ...
            'when insurerNumber is empty' => [
                ...
                ['insurerNumber' => ''],
                ['insurerNumber' => $this->examples->ltcsInsCards[0]->insurerNumber],
            ],
            ...
            'when insurerName is empty' => [
                ...
                ['insurerName' => ''],
                ['insurerName' => $this->examples->ltcsInsCards[0]->insurerName],
            ],
            ...
            'when ltcsLevel is empty' => [
                ['ltcsLevel' => ['入力してください。']],
                ['ltcsLevel' => ''],
                ['ltcsLevel' => $this->examples->ltcsInsCards[0]->ltcsLevel->value()],
            ],
            ...
            'when copayRate is empty' => [
                ['copayRate' => ['入力してください。']],
                ['copayRate' => ''],
                ['copayRate' => $this->examples->ltcsInsCards[0]->copayRate],
            ],
            ...
            'when effectivatedOn is empty' => [
                ...
                ['effectivatedOn' => ''],
                ['effectivatedOn' => $this->examples->ltcsInsCards[0]->effectivatedOn->toDateString()],
            ],
    ...
    private function expectedPayload(array $input): array
    {
        ...
        return $overwrites + ['maxBenefitQuotas' => $maxBenefitQuotas->toArray()] + $input;
    }
}
