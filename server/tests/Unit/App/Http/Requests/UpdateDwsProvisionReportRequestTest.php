...
/**
 * UpdateDwsProvisionReportRequest のテスト.
 */
class UpdateDwsProvisionReportRequestTest extends Test
{
    use CarbonMixin;
    use ConfigMixin;
    ...
    private UpdateDwsProvisionReportRequest $request;
    ...
    {
        static::beforeEachSpec(function (UpdateDwsProvisionReportRequestTest $self): void {
                ...
                ->andReturn(
                    FinderResult::from(
                        [$self->examples->dwsProvisionReports[0]->copy([
                            'plans' => [
                                $self->examples->dwsProvisionReports[0]->plans[0]->copy([
                                    'category' => DwsProjectServiceCategory::physicalCare(),
                                    'schedule' => Schedule::create([
                                        'date' => Carbon::create(2020, 3, 31),
                                        'start' => Carbon::create(2020, 3, 31, 23, 45, 0),
                                        'end' => Carbon::create(2020, 4, 1, 0, 15, 0),
                                    ]),
                                ]),
                            ],
                            'results' => [
            ...
            $self->request = new UpdateDwsProvisionReportRequest();
    ...
    public function describe_validation(): void
    {
        ...
        $examples = [
            ...
            'when plans contain overlapped previous month' => [
                [
                    'plans' => ['前月の時間と重複しないように入力してください。'],
                ],
                [
                    'plans.0.category' => DwsProjectServiceCategory::physicalCare()->value(),
                    'plans.0.schedule' => [
                        'date' => Carbon::parse('2020-04-01')->toDateString(),
                        'start' => Carbon::parse('2020-04-01')->format(DateTimeInterface::ISO8601),
                        'end' => Carbon::parse('2020-04-01')->addMinutes(30)->format(DateTimeInterface::ISO8601),
                    ],
                ],
                [
                    'plans.0.schedule' => [
            ...
            'when plans.0.schedule.end is overtime' => [
                ['plans.0.schedule.end' => ['翌月分の時間を含まないように入力してください。']],
                [
                    'plans.0.schedule' => [
                        'date' => Carbon::parse('2022-03-31')
                            ->format(DateTimeInterface::ISO8601),
                        'start' => Carbon::parse('2022-03-31 23:45:00')
                            ->format(DateTimeInterface::ISO8601),
                        'end' => Carbon::parse('2022-03-31 23:45:00')
                            ->addHour()
                            ->format(DateTimeInterface::ISO8601),
                    ],
                ],
            ...
            'when results contain overlapped previous month' => [
                [
                    'results' => ['前月の時間と重複しないように入力してください。'],
                ],
                [
            ...
            'when results.0.schedule.end is overtime' => [
                ['results.0.schedule.end' => ['翌月分の時間を含まないように入力してください。']],
                [
                    'results.0.schedule' => [
                        'date' => Carbon::parse('2022-03-31')
                            ->format(DateTimeInterface::ISO8601),
