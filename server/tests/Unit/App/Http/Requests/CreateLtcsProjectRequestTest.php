...
/**
 * CreateLtcsProjectRequest のテスト.
 */
class CreateLtcsProjectRequestTest extends Test
{
    use CarbonMixin;
    use ConfigMixin;
    ...
    protected CreateLtcsProjectRequest $request;
    ...
    {
        static::beforeEachSpec(function (CreateLtcsProjectRequestTest $self): void {
            $self->ltcsProject = $self->examples->ltcsProjects[0];
            $self->request = new CreateLtcsProjectRequest();
            ...
            $self->lookupOfficeUseCase
                ->allows('handle')
                ->with(anInstanceOf(Context::class), [Permission::createLtcsProjects()], self::NOT_EXISTING_ID)
            ...
            $self->lookupOwnExpenseProgramUseCase
                ->allows('handle')
                ->with(anInstanceOf(Context::class), Permission::createLtcsProjects(), $self->examples->ownExpensePrograms[2]->id)
     ...
     */
    private function expectedPayload(array $input): LtcsProject
    {
