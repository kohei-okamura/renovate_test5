...
/**
 * FindLtcsAreaGradeRequest のテスト.
 */
class FindLtcsAreaGradeRequestTest extends Test
{
    use ContextMixin;
    ...
    private FindLtcsAreaGradeRequest $request;
    ...
    {
        static::beforeEachSpec(function (FindLtcsAreaGradeRequestTest $self): void {
            $self->request = (new FindLtcsAreaGradeRequest())->replace($self->input());
        });
    }
