...
/**
 * CreateUserBillingInvoiceRequest のテスト
 */
class CreateUserBillingInvoiceRequestTest extends Test
{
    use ConfigMixin;
    ...
    protected CreateUserBillingInvoiceRequest $request;
    ...
    {
        static::beforeEachSpec(function (CreateUserBillingInvoiceRequestTest $self): void {
            $self->request = new CreateUserBillingInvoiceRequest();
