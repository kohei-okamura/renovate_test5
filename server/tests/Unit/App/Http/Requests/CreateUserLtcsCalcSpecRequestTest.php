...
/**
 * {@link \App\Http\Requests\CreateUserLtcsCalcSpecRequest} のテスト.
 */
final class CreateUserLtcsCalcSpecRequestTest extends Test
{
    use CarbonMixin;
    use ConfigMixin;
    ...
    private CreateUserLtcsCalcSpecRequest $request;
    ...
    public static function _setUpSuite(): void
    {
        ...
        self::beforeEachSpec(function (self $self): void {
            $self->request = new CreateUserLtcsCalcSpecRequest();
