...
/**
 * {@link \App\Http\Requests\GetIndexStaffOptionRequest} のテスト.
 */
class GetIndexStaffOptionRequestTest extends Test
{
    use CarbonMixin;
    use ConfigMixin;
    ...
    protected GetIndexStaffOptionRequest $request;
    ...
    {
        static::beforeEachSpec(function (GetIndexStaffOptionRequestTest $self): void {
            $self->request = new GetIndexStaffOptionRequest();
    ...
    public function describe_validation(): void
    {
        ...
        $examples = [
            ...
            'when unauthorized permission given' => [
                ...
                ['permission' => Permission::createStaffs()->value()],
                ['permission' => Permission::listStaffs()->value()],
            ],
