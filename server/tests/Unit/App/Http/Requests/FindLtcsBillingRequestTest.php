...
/**
 * {@link \App\Http\Requests\FindLtcsBillingRequest} のテスト.
 */
final class FindLtcsBillingRequestTest extends Test
{
    use ConfigMixin;
    use ContextMixin;
    ...
    private FindLtcsBillingRequest $request;
    ...
    public static function _setUpSuite(): void
    {
        self::beforeEachSpec(function (self $self): void {
            $self->request = (new FindLtcsBillingRequest())->replace($self->input());
    ...
    public function describe_validation(): void
    {
        $examples = [
            ...
            'when statuses is not array ' => [
                ...
                ['statuses' => 10],
                ['statuses' => [
                    LtcsBillingStatus::checking()->value(),
                    LtcsBillingStatus::fixed()->value(),
                ]],
            ],
            'when statuses contains invalid elements' => [
                ['statuses.0' => ['介護保険サービス：請求：状態を指定してください。']],
                ['statuses' => [self::INVALID_ENUM_VALUE]],
                ['statuses' => [LtcsBillingStatus::checking()->value()]],
            ],
        ];
        $this->should(
    ...
    private function input(): array
    {
        return [
            ...
            'end' => '2020-01',
            'statuses' => [
                (string)LtcsBillingStatus::checking()->value(),
                (string)LtcsBillingStatus::fixed()->value(),
            ],
        ];
    }
