...
/**
 * {@link \App\Http\Requests\GetLtcsProvisionReportScoreSummaryRequest} のテスト.
 */
class GetLtcsProvisionReportScoreSummaryRequestTest extends Test
{
    use CarbonMixin;
    use ConfigMixin;
    ...
    protected GetLtcsProvisionReportScoreSummaryRequest $request;
    ...
    {
        static::beforeEachSpec(function (GetLtcsProvisionReportScoreSummaryRequestTest $self): void {
            ...
            $self->getLtcsProvisionReportScoreSummaryUseCase
                ...
                ->byDefault();
            $self->request = new GetLtcsProvisionReportScoreSummaryRequest(new LtcsProvisionReportFormDelegateImpl());
            ...
            $self->lookupOwnExpenseProgramUseCase
                ->allows('handle')
                ->with(anInstanceOf(Context::class), $requiredPermission, $self->examples->ownExpensePrograms[2]->id)
    ...
    public function describe_validation(): void
    {
        ...
        $examples = [
            ...
            'when serviceCode is serviceCode' => [
            ...
            'when serviceCode is invalid format' => [
                ['entries.0.serviceCode' => ['書式が正しくありません。']],
                ['entries.0.serviceCode' => '_'],
                ['entries.0.serviceCode' => $this->ltcsProvisionReport->entries[0]->serviceCode->toString()],
            ],
