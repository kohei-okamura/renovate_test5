...
/**
 * {@link \App\Http\Requests\CreateUserDwsCalcSpecRequest} のテスト.
 */
final class CreateUserDwsCalcSpecRequestTest extends Test
{
    use CarbonMixin;
    use ConfigMixin;
    ...
    private CreateUserDwsCalcSpecRequest $request;
    ...
    public static function _setUpSuite(): void
    {
        ...
        self::beforeEachSpec(function (self $self): void {
            $self->request = new CreateUserDwsCalcSpecRequest();
