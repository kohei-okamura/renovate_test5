...
/**
 * {@link \App\Http\Requests\UpdateOrganizationSettingRequest} のテスト.
 */
class UpdateOrganizationSettingRequestTest extends Test
{
    use CarbonMixin;
    use ConfigMixin;
    ...
    protected UpdateOrganizationSettingRequest $request;
    ...
    {
        static::beforeEachSpec(function (UpdateOrganizationSettingRequestTest $self): void {
            $self->faker = app(Generator::class);
            $self->request = new UpdateOrganizationSettingRequest();
    ...
    public function describe_payload(): void
    {
        $this->should('payload return organizationSetting', function (): void {
            ...
            $expected = ['bankingClientCode' => '9999999999'];
            $this->assertEquals(
                $expected,
