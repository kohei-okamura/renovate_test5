...
/**
 * {@link \App\Http\Requests\GetLtcsHomeVisitLongTermCareDictionaryEntryRequest} のテスト.
 */
class GetLtcsHomeVisitLongTermCareDictionaryEntryRequestTest extends Test
{
    use ConfigMixin;
    ...
    protected GetLtcsHomeVisitLongTermCareDictionaryEntryRequest $request;
    ...
    {
        static::beforeEachSpec(function (GetLtcsHomeVisitLongTermCareDictionaryEntryRequestTest $self): void {
            $self->request = new GetLtcsHomeVisitLongTermCareDictionaryEntryRequest();
