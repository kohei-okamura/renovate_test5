...
/**
 * UpdateUserBankAccountRequest のテスト
 */
class UpdateUserBankAccountRequestTest extends Test
{
    use ConfigMixin;
    ...
    protected UpdateUserBankAccountRequest $request;
    ...
    {
        static::beforeEachSpec(function (UpdateUserBankAccountRequestTest $self): void {
            $self->request = new UpdateUserBankAccountRequest();
    ...
    public function describe_validation(): void
    {
        ...
        $examples = [
            ...
            'when bankCode is the JP bank and bankAccountNumber is not 8 digits' => [
                ['bankAccountNumber' => ['ゆうちょ銀行の場合は8桁、それ以外の場合は7桁になるように入力してください。']],
                ['bankCode' => '9900', 'bankAccountNumber' => '7654321'],
                ['bankCode' => '9900', 'bankAccountNumber' => '87654321'],
            ],
            'when bankCode is not the JP bank and bankAccountNumber is not 7 digits' => [
                ['bankAccountNumber' => ['ゆうちょ銀行の場合は8桁、それ以外の場合は7桁になるように入力してください。']],
                ['bankCode' => '0005', 'bankAccountNumber' => '12345678'],
                ['bankCode' => '0005', 'bankAccountNumber' => '1234567'],
            ],
