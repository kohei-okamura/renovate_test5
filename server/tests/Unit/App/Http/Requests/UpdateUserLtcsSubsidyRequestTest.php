...
/**
 * UpdateUserLtcsSubsidyRequest のテスト
 */
class UpdateUserLtcsSubsidyRequestTest extends Test
{
    use ConfigMixin;
    use ExamplesConsumer;
    use UnitSupport;

    protected UpdateUserLtcsSubsidyRequest $request;
    ...
    {
        static::beforeEachSpec(function (UpdateUserLtcsSubsidyRequestTest $self): void {
            $self->request = new UpdateUserLtcsSubsidyRequest();
    ...
    {
        $this->should('payload return UserLtcsSubsidy', function (): void {
