...
/**
 * {@link \UseCase\Billing\GetDwsBillingInfoUseCase} Mixin.
 *
 * @mixin \Tests\Unit\Helpers\UnitSupport
 */
trait GetDwsBillingInfoUseCaseMixin
{
    /**
     * @var \Mockery\MockInterface|\UseCase\Billing\GetDwsBillingInfoUseCase
     */
    protected $getDwsBillingInfoUseCase;
    ...
    public static function mixinGetDwsBillingInfoUseCase(): void
    {
        static::beforeEachTest(function ($self): void {
            ...
            app()->bind(
                GetDwsBillingInfoUseCase::class,
                fn () => $self->getDwsBillingInfoUseCase
            );
        });
        static::beforeEachSpec(function ($self): void {
            assert($self instanceof self);
            $self->getDwsBillingInfoUseCase = Mockery::mock(
                GetDwsBillingInfoUseCase::class
            );
        });
    }
