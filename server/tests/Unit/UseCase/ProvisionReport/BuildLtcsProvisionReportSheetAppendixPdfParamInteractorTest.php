...
/**
 * {@link \UseCase\ProvisionReport\BuildLtcsProvisionReportSheetAppendixPdfParamInteractor} のテスト.
 */
final class BuildLtcsProvisionReportSheetAppendixPdfParamInteractorTest extends Test
{
    use ContextMixin;
    ...
    private BuildLtcsProvisionReportSheetAppendixPdfParamInteractor $interactor;
    ...
    public static function _setUpSuite(): void
    {
        ...
        self::beforeEachSpec(function (self $self): void {
            ...
            $self->interactor = app(BuildLtcsProvisionReportSheetAppendixPdfParamInteractor::class);
        });
    }
