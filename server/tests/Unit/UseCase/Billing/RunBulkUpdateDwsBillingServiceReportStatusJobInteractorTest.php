...
use Tests\Unit\Mixins\BulkUpdateDwsBillingServiceReportStatusUseCaseMixin;
...
/**
 * {@link \UseCase\Billing\RunBulkUpdateDwsBillingServiceReportStatusJobInteractor} のテスト.
 */
final class RunBulkUpdateDwsBillingServiceReportStatusJobInteractorTest extends Test
{
    use BulkUpdateDwsBillingServiceReportStatusUseCaseMixin;
    use ContextMixin;
    ...
    private RunBulkUpdateDwsBillingServiceReportStatusJobInteractor $interactor;
    ...
    public static function _setUpSuite(): void
    {
        self::beforeEachSpec(function (self $self): void {
            ...
            $self->runJobUseCase
                ...
                ->andReturnNull()
                ->byDefault();
            $self->bulkUpdateDwsBillingServiceReportStatusUseCase
                ->allows('handle')
                ->andReturnNull()
                ->byDefault();
            ...
            $self->interactor = app(RunBulkUpdateDwsBillingServiceReportStatusJobInteractor::class);
        });
    }
