...
/**
 * {@link \Usecase\Calling\SendThirdCallingInteractor} Test.
 */
class SendThirdCallingInteractorTest extends Test
{
    use CarbonMixin;
    ...
    private SendThirdCallingInteractor $interactor;
    ...
    {
        static::beforeEachSpec(function (SendThirdCallingInteractorTest $self): void {
            ...
            $self->interactor = app(SendThirdCallingInteractor::class);
        });
    }
    ...
    public function describe_handle(): void
    {
        ...
        $this->should('use LookupStaffUseCase', function (): void {
            $this->lookupStaffUseCase
                ->expects('handle')
                ->with($this->context, Permission::viewStaffs(), $this->examples->callings[0]->staffId)
        ...
        $this->should('use EventDispatcher', function (): void {
            $this->eventDispatcher
                ->expects('dispatch')
                ->with(equalTo(new ThirdCallingEvent($this->context, $this->examples->staffs[0])))
                ->andReturnNull();
