 ...
 * 設定例 No.4
 */
class CreateDwsBillingHomeHelpServiceNo4Cest extends CreateDwsBillingTest
{
        ...
        $reportItems = [
            $baseItem->copy([
                'schedule' => Schedule::create([
                    ...
                    'start' => Carbon::create(2021, 4, 4, 10, 0),
                    'end' => Carbon::create(2021, 4, 4, 11, 0),
                ]),
            ]),
        ];
    ...
    private function checkStatementItems(BillingTester $I, DwsBillingBundle $actualBundle)
    {
        ...
        $I->assertArrayStrictEquals([
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('111115'), // 身体日中1.0
            ...
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('111116'), // 身体日中1.0 2人
                serviceCodeCategory: DwsServiceCodeCategory::physicalCare(),
                unitScore: 402,
                count: 1,
                totalScore: 402,
            ...
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('11ZZ01'), // 重訪 COVID-19 加算
                serviceCodeCategory: DwsServiceCodeCategory::covid19PandemicSpecialAddition(),
                unitScore: 1, // これまでの合計 804 * 0.1% = 1 (1以下はすべて1)
                count: 1,
                totalScore: 1,
            ),
            new DwsBillingStatementItem(
                ...
                unitScore: 161, // 合計 805 * 0.2(20%)
                count: 1,
                totalScore: 161,
            ),
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('116710'), // 処遇改善加算2
                serviceCodeCategory: DwsServiceCodeCategory::treatmentImprovementAddition2(),
                unitScore: 193, // 合計 966 * 20.0%
                count: 1,
                totalScore: 193,
            ),
