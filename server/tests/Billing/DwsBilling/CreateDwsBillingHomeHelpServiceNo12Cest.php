...
/**
 * 障害福祉サービス 居宅 請求生成テスト.
 * 設定例 No.12 【月またがり (0 時またがり)】
 */
class CreateDwsBillingHomeHelpServiceNo12Cest extends CreateDwsBillingTest
{
        ...
        $reportItems = [
            $baseItem->copy([
                'schedule' => Schedule::create([
                    'date' => Carbon::create(2021, 3, 31),
                    'start' => Carbon::create(2021, 3, 31, 22),
                    'end' => Carbon::create(2021, 4, 1, 2),
                ]),
            ]),
        ];
    ...
    private function checkServiceReportItems(BillingTester $I, DwsBillingBundle $actualBundle)
    {
        ...
        $I->assertArrayStrictEquals([
            ...
            $baseItem->copy([
                ...
                'plan' => DwsBillingServiceReportDuration::create([
                    'period' => CarbonRange::create([
                        'start' => Carbon::create(2021, 4, 1, 0),
                        'end' => Carbon::create(2021, 4, 1, 2),
                    ]),
