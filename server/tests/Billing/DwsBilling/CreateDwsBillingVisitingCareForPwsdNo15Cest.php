 ...
 * 設定例No.15
 */
final class CreateDwsBillingVisitingCareForPwsdNo15Cest extends CreateDwsBillingTest
{
        ...
        $reportItems = [
            DwsProvisionReportItem::create([
                'schedule' => Schedule::create([
                    ...
                    'start' => Carbon::create(2021, 4, 15, 8, 0),
                    'end' => Carbon::create(2021, 4, 15, 12, 0),
                ]),
            ...
            DwsProvisionReportItem::create([
                'schedule' => Schedule::create([
                    'date' => Carbon::create(2021, 4, 15),
                    'start' => Carbon::create(2021, 4, 15, 14, 0),
                    'end' => Carbon::create(2021, 4, 15, 16, 0),
                ]),
                'category' => DwsProjectServiceCategory::visitingCareForPwsd(),
                'headcount' => 2,
                'movingDurationMinutes' => 0,
