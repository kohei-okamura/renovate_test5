...
/**
 * 障害福祉サービス 居宅 請求生成テスト.
 * 世田谷区手引き 設定例 No.9 (家事援助）
 */
final class CreateDwsBillingHomeHelpServiceSetagayaNo9Cest extends CreateDwsBillingTest
{
        ...
        $reportResults = [
            DwsProvisionReportItem::create([
                'schedule' => Schedule::create([
                    'date' => Carbon::create(2021, 4, 9),
                    'start' => Carbon::create(2021, 4, 9, 16, 0),
                    'end' => Carbon::create(2021, 4, 9, 19, 0),
                ]),
    ...
    private function checkStatementItems(BillingTester $I, DwsBillingBundle $actualBundle)
    {
        ...
        $I->assertArrayStrictEquals([
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('116123'), // 家事日中2.0
            ...
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('116491'), // 家事夜間増1.0
                serviceCodeCategory: DwsServiceCodeCategory::housework(),
                unitScore: 175,
                count: 1,
                totalScore: 175,
