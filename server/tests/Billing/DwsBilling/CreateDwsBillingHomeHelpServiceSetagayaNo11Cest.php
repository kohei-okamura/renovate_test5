 ...
 * 世田谷区手引き 設定例No.11 (身体)
 */
final class CreateDwsBillingHomeHelpServiceSetagayaNo11Cest extends CreateDwsBillingTest
{
        ...
        $reportResults = [
            DwsProvisionReportItem::create([
                'schedule' => Schedule::create([
                    ...
                    'start' => Carbon::create(2021, 4, 11, 23, 0),
                    'end' => Carbon::create(2021, 4, 12, 7, 0),
                ]),
                'category' => DwsProjectServiceCategory::physicalCare(),
                'headcount' => 1,
                'movingDurationMinutes' => 0,
                'options' => [],
                'note' => '世田谷区手引き設定例No.11',
            ]),
        ];
    ...
    private function checkStatementItems(BillingTester $I, DwsBillingBundle $actualBundle)
    {
        ...
        $I->assertArrayStrictEquals([
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('111255'), // 身体深夜1.0
            ...
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('111579'), // 身体日跨増深夜1.0・深夜2.0
                serviceCodeCategory: DwsServiceCodeCategory::physicalCare(),
                unitScore: 647,
                count: 1,
                totalScore: 647,
            ...
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('111995'), // 身体深夜増4.0
                serviceCodeCategory: DwsServiceCodeCategory::physicalCare(),
                unitScore: 996,
                count: 1,
                totalScore: 996,
            ...
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('111915'), // 身体早朝増1.0
                serviceCodeCategory: DwsServiceCodeCategory::physicalCare(),
                unitScore: 208,
                count: 1,
                totalScore: 208,
