 ...
 * 世田谷区手引き 設定例No.12 (身体)
 */
final class CreateDwsBillingHomeHelpServiceSetagayaNo12Cest extends CreateDwsBillingTest
{
        ...
        $reportResults = [
            DwsProvisionReportItem::create([
                'schedule' => Schedule::create([
                    ...
                    'start' => Carbon::create(2021, 4, 12, 21, 0),
                    'end' => Carbon::create(2021, 4, 13, 3, 0),
                ]),
                'category' => DwsProjectServiceCategory::physicalCare(),
                'headcount' => 1,
                'movingDurationMinutes' => 0,
                'options' => [],
                'note' => '世田谷区手引き設定例No.12',
            ]),
        ];
    ...
    private function checkStatementItems(BillingTester $I, DwsBillingBundle $actualBundle)
    {
        ...
        $I->assertArrayStrictEquals([
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('111519'), // 身体夜間1.0＋深夜2.0
            ...
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('111987'), // 身体深夜増3.0
                serviceCodeCategory: DwsServiceCodeCategory::physicalCare(),
                unitScore: 747,
                count: 1,
                totalScore: 747,
