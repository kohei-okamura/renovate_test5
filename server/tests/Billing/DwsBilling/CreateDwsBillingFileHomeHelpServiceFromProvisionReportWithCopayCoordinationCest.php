...
/**
 * Billing files Create (居宅) のテスト. 予実から生成し、上限管理も行う.
 */
final class CreateDwsBillingFileHomeHelpServiceFromProvisionReportWithCopayCoordinationCest extends CreateDwsBillingTest
{
