 ...
 * 設定例No.6
 */
final class CreateDwsBillingVisitingCareForPwsdNo6Cest extends CreateDwsBillingTest
{
    ...
    private function checkStatementItems(BillingTester $I, DwsBillingBundle $actualBundle): void
    {
        ...
        $I->assertArrayStrictEquals([
            ...
            new DwsBillingStatementItem(
                ...
                unitScore: 4, // 移動介護加算を除く 4,314 単位 × 0.1% = 4.314 を四捨五入
                count: 1,
                totalScore: 4,
            ),
            new DwsBillingStatementItem(
                ...
                unitScore: 864, // 移動介護加算を除く (4,314 + 4) = 4,315 単位 × 20% = 863.6 を四捨五入
                count: 1,
                totalScore: 864,
            ),
            new DwsBillingStatementItem(
                ...
                unitScore: 786, // 合計 5,382 単位 × 14.6% = 785.772 を四捨五入
                count: 1,
                totalScore: 786,
            ),
