...
/**
 * 障害福祉サービス 居宅 請求生成テスト.
 * 世田谷区手引き 設定例 No.10 (家事援助）
 */
final class CreateDwsBillingHomeHelpServiceSetagayaNo10Cest extends CreateDwsBillingTest
{
        ...
        $reportResults = [
            DwsProvisionReportItem::create([
                'schedule' => Schedule::create([
                    ...
                    'start' => Carbon::create(2021, 4, 10, 17, 0),
                    'end' => Carbon::create(2021, 4, 10, 19, 0),
                ]),
                'category' => DwsProjectServiceCategory::housework(),
                'headcount' => 1,
                'movingDurationMinutes' => 0,
                'options' => [],
                'note' => '世田谷区手引き設定例No.10',
            ]),
        ];
    ...
    private function checkStatementItems(BillingTester $I, DwsBillingBundle $actualBundle)
    {
        ...
        $I->assertArrayStrictEquals([
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('116335'), // 家事日中1.0＋夜間0.5
            ...
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('116487'), // 家事夜間増0.5
                serviceCodeCategory: DwsServiceCodeCategory::housework(),
                unitScore: 88,
                count: 1,
                totalScore: 88,
