 ...
 * POST /dws-billings
 */
final class CreateDwsBillingVisitingCareForPwsdBaseIncreaseAdditionCest extends CreateDwsBillingTest
{
    ...
    /**
     * API正常呼び出しテスト(福祉・介護職員等ベースアップ加算がある場合).
     *
    ...
    public function succeedAPICall(BillingTester $I)
    {
        ...
        $reportResults = [
            DwsProvisionReportItem::create([
                'schedule' => Schedule::create([
                    'date' => Carbon::create(2022, 2, 10),
                    'start' => Carbon::create(2022, 10, 1, 4, 00),
                    'end' => Carbon::create(2022, 10, 1, 7, 00),
                ]),
            ...
            DwsProvisionReportItem::create([
                'schedule' => Schedule::create([
                    ...
                    'start' => Carbon::create(2022, 10, 1, 8, 00),
                    'end' => Carbon::create(2022, 10, 1, 11, 00),
                ]),
                'category' => DwsProjectServiceCategory::visitingCareForPwsd(),
                'headcount' => 1,
                'movingDurationMinutes' => 0,
            ...
            DwsProvisionReportItem::create([
                'schedule' => Schedule::create([
                    'date' => Carbon::create(2022, 10, 1),
                    'start' => Carbon::create(2022, 10, 1, 12, 00),
                    'end' => Carbon::create(2022, 10, 1, 15, 00),
                ]),
                'category' => DwsProjectServiceCategory::visitingCareForPwsd(),
                'headcount' => 1,
                'movingDurationMinutes' => 0,
        ...
        // 請求単位
        $certification = $this->examples->dwsCertifications[26];
        ...
        $I->assertModelStrictEquals(DwsBillingStatement::create([
            ...
            'items' => [
                ...
                new DwsBillingStatementItem(
                    serviceCode: ServiceCode::fromString('126766'), // 福祉・介護職員等ベースアップ等支援加算
                    serviceCodeCategory: DwsServiceCodeCategory::baseIncreaseSupportAddition(),
                    unitScore: 82, // 合計1812 * 0.045(4.5%)
                    count: 1,
                    totalScore: 82,
                ),
            ],
        ...
        $I->assertModelStrictEquals(DwsBillingServiceReport::create([
            ...
            'items' => [
                DwsBillingServiceReportItem::create([
                    ...
                    'result' => DwsBillingServiceReportDuration::create([
                        'period' => CarbonRange::create([
                            'start' => Carbon::create(2022, 10, 1, 4, 0),
                            'end' => Carbon::create(2022, 10, 1, 7, 0),
                        ]),
                    ]),
                    'serviceCount' => 0,
                    'headcount' => 1,
                ...
                DwsBillingServiceReportItem::create([
                    ...
                    'result' => DwsBillingServiceReportDuration::create([
                        'period' => CarbonRange::create([
                            'start' => Carbon::create(2022, 10, 1, 8, 0),
                            'end' => Carbon::create(2022, 10, 1, 11, 0),
                        ]),
                    ]),
                ...
                DwsBillingServiceReportItem::create([
                    ...
                    'result' => DwsBillingServiceReportDuration::create([
                        'period' => CarbonRange::create([
                            'start' => Carbon::create(2022, 10, 1, 12, 0),
                            'end' => Carbon::create(2022, 10, 1, 15, 0),
                        ]),
