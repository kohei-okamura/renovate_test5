...
/**
 * 障害福祉サービス 居宅 請求生成テスト.
 * 世田谷区手引き 設定例 No.8(家事援助）
 */
final class CreateDwsBillingHomeHelpServiceSetagayaNo8Cest extends CreateDwsBillingTest
{
        ...
        $reportResults = [
            DwsProvisionReportItem::create([
                'schedule' => Schedule::create([
                    ...
                    'start' => Carbon::create(2021, 4, 8, 7, 15),
                    'end' => Carbon::create(2021, 4, 8, 9, 45),
                ]),
    ...
    private function checkStatementItems(BillingTester $I, DwsBillingBundle $actualBundle)
    {
        ...
        $I->assertArrayStrictEquals([
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('117871'), // 家事早朝0.75日中0.75
            ...
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('116387'), // 家事日中増1.0
                serviceCodeCategory: DwsServiceCodeCategory::housework(),
                unitScore: 140,
                count: 1,
                totalScore: 140,
