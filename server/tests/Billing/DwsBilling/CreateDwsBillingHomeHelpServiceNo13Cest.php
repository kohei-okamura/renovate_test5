...
/**
 * 障害福祉サービス 居宅 請求生成テスト.
 * 設定例 No.13 【月またがり (0 時またがり)】
 */
class CreateDwsBillingHomeHelpServiceNo13Cest extends CreateDwsBillingTest
{
        ...
        $reportItems = [
            $baseItem->copy([
                'schedule' => Schedule::create([
                    ...
                    'start' => Carbon::create(2021, 3, 31, 23, 50),
                    'end' => Carbon::create(2021, 4, 1, 0, 50),
                ]),
            ]),
        ];
    ...
    private function checkStatementItems(BillingTester $I, DwsBillingBundle $actualBundle)
    {
        ...
        $I->assertArrayStrictEquals([
            new DwsBillingStatementItem(
                serviceCode: ServiceCode::fromString('111547'), // 身体日跨増深０．５・深０．５
    ...
    private function checkServiceReportItems(BillingTester $I, DwsBillingBundle $actualBundle)
    {
        ...
        $I->assertArrayStrictEquals([
            $baseItem->copy([
                ...
                'plan' => DwsBillingServiceReportDuration::create([
                    'period' => CarbonRange::create([
                        'start' => Carbon::create(2021, 3, 31, 23, 50),
                        'end' => Carbon::create(2021, 4, 1, 0, 20),
                    ]),
            ...
            $baseItem->copy([
                ...
                'plan' => DwsBillingServiceReportDuration::create([
                    'period' => CarbonRange::create([
                        'start' => Carbon::create(2021, 4, 1, 0, 20),
                        'end' => Carbon::create(2021, 4, 1, 0, 50),
                    ]),
                    'serviceDurationHours' => Decimal::fromInt(5_000),
                ]),
                'result' => DwsBillingServiceReportDuration::create([
                    'period' => CarbonRange::create([
                        'start' => Carbon::create(2021, 4, 1, 0, 20),
