 ...
 * 設定例No.10
 */
class CreateDwsBillingVisitingCareForPwsdNo12Cest extends CreateDwsBillingTest
{
        ...
        $reportItems = [
            DwsProvisionReportItem::create([
                'schedule' => Schedule::create([
                    'date' => Carbon::create(2021, 4, 12),
                    'start' => Carbon::create(2021, 4, 12, 23, 45),
                    'end' => Carbon::create(2021, 4, 13, 2, 45),
                ]),
    ...
    private function checkStatementItems(BillingTester $I, DwsBillingBundle $actualBundle)
    {
        ...
        $I->assertArrayStrictEquals([
            ...
            new DwsBillingStatementItem(
                ...
                unitScore: 1, // これまでの合計 829 * 0.1% = 1 (1以下はすべて1)
                count: 1,
                totalScore: 1,
            ),
            new DwsBillingStatementItem(
    ...
    private function checkServiceReportItems(BillingTester $I, DwsBillingBundle $actualBundle)
    {
        ...
        $I->assertArrayStrictEquals([
            ...
            $baseItem->copy([
                'serialNumber' => 2,
                'providedOn' => Carbon::create(2021, 4, 13),
                'plan' => DwsBillingServiceReportDuration::create([
                    'period' => CarbonRange::create([
                        'start' => Carbon::create(2021, 4, 13, 0, 45),
                        'end' => Carbon::create(2021, 4, 13, 2, 45),
                    ]),
