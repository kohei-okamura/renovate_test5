...
/**
 * UserLtcsSubsidies get のテスト.
 * GET /users/{userId}/ltcs-subsidies/{id}
 */
class GetUserLtcsSubsidyCest extends UserLtcsSubsidyTest
{
    ...
    public function succeedAPICall(ApiTester $I)
    {
        ...
        $expected = $this->domainToArray(['ltcsSubsidy' => $userLtcsSubsidy]);
    ...
    public function failedWithNotFoundIfIdNotExist(ApiTester $I)
    {
        ...
        $I->sendGET("/users/{$this->examples->users[0]->id}/ltcs-subsidies/{$id}");
    ...
    public function failedWithNotFoundWhenUserDoesNotExist(ApiTester $I)
    {
        ...
        $I->sendGET("/users/{$userId}/ltcs-subsidies/{$userLtcsSubsidy->id}");
    ...
    public function failedWithNotFoundWhenUserIdIsNotInAccessibleOffice(ApiTester $I)
    {
        ...
        $I->sendGET("users/{$userId}/ltcs-subsidies/{$id}");
