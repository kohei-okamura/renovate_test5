...
/**
 * UserLtcsSubsidies delete のテスト.
 * DELETE /users/{userId}/ltcs-subsidies/{id}
 */
class DeleteUserLtcsSubsidyCest extends UserLtcsSubsidyTest
{
    ...
    public function succeedAPICall(ApiTester $I)
    {
        ...
        $I->sendDELETE("/users/{$this->examples->users[0]->id}/ltcs-subsidies/{$userLtcsSubsidy->id}");

        $I->seeResponseCodeIs(HttpCode::NO_CONTENT);
        $I->seeLogCount(1);
        $I->seeLogMessage(0, LogLevel::INFO, '公費情報が削除されました', [
    ...
    public function failedWithNotFoundIfIdNotExist(ApiTester $I)
    {
        ...
        $I->sendDELETE("/users/{$this->examples->users[0]->id}/ltcs-subsidies/{$id}");
    ...
    public function failedWithNotFoundWhenUserDoesNotExist(ApiTester $I)
    {
        ...
        $I->sendDELETE("/users/{$userId}/ltcs-subsidies/{$userLtcsSubsidy->id}");
    ...
    public function failedWithNotFoundWhenUserIdIsNotInAccessibleOffice(ApiTester $I)
    {
        ...
        $I->sendDELETE("users/{$userId}/ltcs-subsidies/{$id}");
