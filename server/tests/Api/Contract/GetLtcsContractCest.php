...
/**
 * Contract Get のテスト.
 * GET /users/{userId}/ltcs-contracts/{id}
 */
class GetLtcsContractCest extends ContractTest
{
    ...
    public function failedWithNotFoundWheneUserIdIsString(ApiTester $I)
    {
        ...
        $I->sendGET("users/userId/ltcs-contracts/{$contract->id}");
    ...
    public function failedWithNotFoundWhenIdIsString(ApiTester $I)
    {
        ...
        $I->sendGET("users/{$contract->userId}/ltcs-contracts/id");
    ...
    public function failedWithNotFoundWhenUserIsOutsideOrganization(ApiTester $I)
    {
        ...
        $I->sendGET("users/{$userId}/ltcs-contracts/{$id}");
