...
/**
 * DwsContract create のテスト.
 * POST /dws-contracts
 */
class CreateDwsContractCest extends ContractTest
{
    ...
    public function succeedAPICall(ApiTester $I)
    {
        ...
        $I->sendPOST('users/' . $this->examples->users[5]->id . '/dws-contracts', $this->domainToArray($this->examples->contracts[0]));
    ...
    public function failedWithBadRequestWhenOfficeIdNotExists(ApiTester $I)
    {
        ...
        $I->sendPOST("users/{$this->examples->users[0]->id}/dws-contracts", $param);
    ...
    public function failedWithBadRequestWhenOfficeIdIsOutsideOrganization(ApiTester $I)
    {
        ...
        $param = ['officeId' => $officeId] + $this->domainToArray($this->examples->contracts[0]);

        $I->sendPOST("users/{$userId}/dws-contracts", $param);
    ...
    public function failedWithNotFoundWhenInvalidUserId(ApiTester $I)
    {
        ...
        $I->sendPOST("users/{$userId}/dws-contracts", $this->domainToArray($this->examples->contracts[0]));
    ...
    public function failedWithNotFoundWhenUserIsOutsideOrganization(ApiTester $I)
    {
        ...
        $I->sendPOST("users/{$userId}/dws-contracts", $this->domainToArray($this->examples->contracts[1]));
    ...
    public function failWithForbiddenWhenNotHavingPermission(ApiTester $I)
    {
        ...
        $I->sendPOST("users/{$this->examples->users[0]->id}/dws-contracts", $this->domainToArray($this->examples->contracts[0]));
