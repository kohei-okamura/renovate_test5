 ...
 */
class GetReportCest extends Test
{
    ...
    public function succeedAPICall(ApiTester $I)
    {
        ...
        $report = $this->examples->dwsBillingServiceReports[2];
        $expected = $this->domainToArray(compact('billing', 'bundle', 'report'));

        $I->sendGET("/dws-billings/{$billing->id}/bundles/{$bundle->id}/reports/{$report->id}");
    ...
    public function failWithNotFoundIfIdNotExist(ApiTester $I)
    {
        ...
        $I->sendGET("/dws-billings/{$billing->id}/bundles/{$bundle->id}/reports/{$id}");
    ...
    public function failWithNotFoundIfBillingIdNotExist(ApiTester $I)
    {
        ...
        $bundle = $this->examples->dwsBillingBundles[1];
        $copayCoordination = $this->examples->dwsBillingServiceReports[2];

        $I->sendGET("/dws-billings/{$billingId}/bundles/{$bundle->id}/reports/{$copayCoordination->id}");
    ...
    public function failWithNotFoundIfBundleIdNotExist(ApiTester $I)
    {
        ...
        $I->sendGET("/dws-billings/{$billing->id}/bundles/{$bundleId}/reports/{$copayCoordination->id}");
    ...
    public function failWithNotFoundIfBillingIdNotInOrganization(ApiTester $I)
    {
        ...
        $I->sendGET("/dws-billings/{$billing->id}/bundles/{$bundle->id}/reports/{$copayCoordination->id}");
