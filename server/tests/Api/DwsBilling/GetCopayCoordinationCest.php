...
/**
 * CopayCoordination get のテスト(Dws).
 * GET /dws-billings/{billingId}/bundles/{copay-coordinations/{id}
 */
class GetCopayCoordinationCest extends Test
{
    ...
    public function succeedAPICall(ApiTester $I)
    {
        ...
        $copayCoordination = $this->examples->dwsBillingCopayCoordinations[2];
        $expected = $this->domainToArray(compact('billing', 'bundle', 'copayCoordination'));

        $I->sendGET("/dws-billings/{$billing->id}/bundles/{$bundle->id}/copay-coordinations/{$copayCoordination->id}");
    ...
    public function failWithNotFoundIfIdNotExist(ApiTester $I)
    {
        ...
        $I->sendGET("/dws-billings/{$billing->id}/bundles/{$bundle->id}/copay-coordinations/{$id}");
    ...
    public function failWithNotFoundIfBillingIdNotExist(ApiTester $I)
    {
        ...
        $I->sendGET("/dws-billings/{$billingId}/bundles/{$bundle->id}/copay-coordinations/{$copayCoordination->id}");
    ...
    public function failWithNotFoundIfBundleIdNotExist(ApiTester $I)
    {
        ...
        $I->sendGET("/dws-billings/{$billing->id}/bundles/{$bundleId}/copay-coordinations/{$copayCoordination->id}");
