...
import Vue from 'vue'
import { ShiftStore } from '~/composables/stores/use-shift-store'
import { NuxtContext } from '~/models/nuxt'
import ShiftStoreProviderPage from '~/pages/shifts/_id.vue'
...
describe('pages/shifts/_id.vue', () => {
  ...
  async function mountComponent (options: MountOptions<Vue> = {}) {
    wrapper = mount(ShiftStoreProviderPage, {
      ...options,
      mocks
    })
