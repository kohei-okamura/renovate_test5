...
import Vue from 'vue'
import { UserBillingStore } from '~/composables/stores/use-user-billing-store'
import { NuxtContext } from '~/models/nuxt'
import UserBillingStoreProviderPage from '~/pages/user-billings/_id.vue'
...
describe('pages/user-billings/_id.vue', () => {
  ...
  async function mountComponent (options: MountOptions<Vue> = {}) {
    wrapper = mount(UserBillingStoreProviderPage, {
      ...options,
      mocks
    })
  ...
  beforeAll(async () => {
    store = createUserBillingStoreStub()
  ...
  it('should call userBillingStore.get', () => {
