...
import Vue from 'vue'
import { AttendanceStore } from '~/composables/stores/use-attendance-store'
import { NuxtContext } from '~/models/nuxt'
import AttendanceStoreProviderPage from '~/pages/attendances/_id.vue'
...
describe('pages/attendances/_id.vue', () => {
  ...
  async function mountComponent (options: MountOptions<Vue> = {}) {
    wrapper = mount(AttendanceStoreProviderPage, {
      ...options,
      mocks
    })
  ...
  beforeAll(async () => {
    store = createAttendanceStoreStub()
  ...
  it('should call attendanceStore.get', () => {
