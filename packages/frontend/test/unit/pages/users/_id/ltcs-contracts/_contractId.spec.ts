...
import Vue from 'vue'
import { LtcsContractStore } from '~/composables/stores/use-ltcs-contract-store'
import { NuxtContext } from '~/models/nuxt'
import LtcsContractStoreProviderPage from '~/pages/users/_id/ltcs-contracts/_contractId.vue'
...
describe('pages/users/_id/ltcs-contracts/_contractId.vue', () => {
  ...
  async function mountComponent (options: MountOptions<Vue> = {}) {
    wrapper = mount(LtcsContractStoreProviderPage, {
      ...options,
      mocks
    })
  ...
  beforeAll(async () => {
    store = createLtcsContractStoreStub()
  ...
  it('should call ltcsContractStore.get', () => {
