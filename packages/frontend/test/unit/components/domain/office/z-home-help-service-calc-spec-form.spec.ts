...
describe('z-home-help-service-calc-spec-form.vue', () => {
  ...
  function mountComponent (options: MountOptions<Vue> = {}) {
    wrapper = mount(ZHomeHelpServiceCalcSpecForm, {
      ...options,
      mocks,
      propsData
    })
  ...
  describe('validation', () => {
    ...
    async function validate (values: Partial<HomeHelpServiceCalcSpecsApi.Form> = {}) {
