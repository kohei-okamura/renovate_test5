...
describe('z-visiting-care-for-pwsd-calc-spec-form.vue', () => {
  ...
  function mountComponent (options: MountOptions<Vue> = {}) {
    wrapper = mount(ZVisitingCareForPwsdCalcSpecForm, {
      ...options,
      mocks,
      propsData
    })
  ...
  describe('validation', () => {
    ...
    async function validate (values: Partial<VisitingCareForPwsdCalcSpecsApi.Form> = {}) {
