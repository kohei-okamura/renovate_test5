...
describe('z-shift-form.vue', () => {
  ...
  type Form = DeepPartial<ShiftsApi.Form>
  ...
  const propsData: Record<string, any> & { value?: Form } = {
    errors: {},
    buttonText: '登録',
  ...
  describe('validation', () => {
    ...
    async function validate (values: DeepPartial<ShiftsApi.Form> = {}) {
