<!--
  ...
  -->
<template>
  <v-form data-z-user-ltcs-calc-spec-form data-form @submit.prevent="submit">
    <validation-observer ref="observer" tag="div">
      <z-user-summary :user="user" />
      <z-form-card title="介護保険サービス算定情報">
...
type Props = FormProps<DeepPartial<UserLtcsCalcSpecsApi.Form>> & Readonly<{
  buttonText: string
...
export default defineComponent<Props>({
  ...
  setup (props: Props, context) {
    ...
    return {
      ...
      locationAdditions: enumerableOptions(LtcsUserLocationAddition),
      rules
    }
  }
})
