...
type Props = FormProps<HomeHelpServiceCalcSpecsApi.Form> & Readonly<{
  buttonText: string
  office: Office
}>

export default defineComponent<Props>({
  name: 'ZHomeHelpServiceCalcSpecForm',
  props: {
    ...getFormPropsOptions(),
  ...
  setup: (props, context) => ({
    ...
    specifiedOfficeAdditions: enumerableOptions(HomeHelpServiceSpecifiedOfficeAddition),
