<!--
  ...
  -->
<template>
  <v-form data-z-shift-form data-form @submit.prevent="submit">
          ...
          <v-row no-gutters>
            <v-col cols="12" md="6">
              <z-form-card-item v-slot="{ errors }" data-schedule-date vid="schedule.date" :rules="rules.schedule.date">
                <z-date-field v-model="form.schedule.date" label="勤務日 *" :error-messages="errors" />
              </z-form-card-item>
            </v-col>
            <v-col class="d-flex" cols="12" md="6">
              ...
              >
                <z-text-field
                  ...
                  type="time"
                  data-schedule-start-input-field
                  label="開始 *"
                  :error-messages="errors"
                  @input="validateDurations"
                />
                ...
                <v-col cols="12" sm="6">
                  ...
                  >
                    <z-hour-and-minute-field
                      ...
                      data-duration-physical-care-input-field
                      label="身体介護 *"
                      :error-messages="errors"
                      @input="validateDurations"
                    />
                ...
                <v-col cols="12" sm="6">
                  ...
                  >
                    <z-hour-and-minute-field
                      ...
                      data-duration-housework-input-field
                      label="生活援助 *"
                      :error-messages="errors"
                      @input="validateDurations"
                    />
              ...
              <v-col cols="12" sm="6">
                ...
                >
                  <z-hour-and-minute-field
                    ...
                    data-duration-resting-input-field
                    label="休憩 *"
                    :error-messages="errors"
                    @input="validateDurations"
                  />
...
import { alphaNum, required, validTimeDuration } from '~/support/validation/rules'
import { validationRules } from '~/support/validation/utils'

type Form = Overwrite<ShiftsApi.Form, {
  ...
  setup (props, context) {
    ...
    const useHints = () => {
      ...
      return {
        ...
        assignerHint: createHint('勤務シフトを管理するスタッフ（責任者）を選択してください。')
      }
    }
