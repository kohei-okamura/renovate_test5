...
import {
  dwsProvisionReportsStateKey,
  dwsProvisionReportsStoreKey,
...
export default defineComponent({
  name: 'DwsProvisionReportStoreProviderPage',
  ...
  setup () {
    ...
    const reportsStore = useDwsProvisionReportsStore()
    provide(dwsProvisionReportsStoreKey, reportsStore)
    provide(dwsProvisionReportsStateKey, reportsStore.state)
    const userStore = useUserStore()
    provide(userStateKey, userStore.state)
    const reportStore = useDwsProvisionReportStore()
    provide(dwsProvisionReportStoreKey, reportStore)
    provide(dwsProvisionReportStateKey, reportStore.state)
    return useAsync(() => {
